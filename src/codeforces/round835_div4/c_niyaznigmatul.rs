// https://codeforces.com/contest/1760/submission/185792411
// By niyaznigmatul#, contest: Codeforces Round #835 (Div. 4), problem: (C) Advantage,
...
pub mod solution {
    ...
    fn solve(input: &mut Input, _test_case: usize) {
        ...
        out_line!(a
            .into_iter()
            .map(|x| x - if x == max1 { max2 } else { max1 })
            .collect::<Vec<_>>());
    }
